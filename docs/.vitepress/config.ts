      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'Tuning Guide', link: '/guide/tuning' },
            { text: 'FAQ', link: '/guide/faq' },
            { text: 'Entity Extraction', link: '/guide/extract' },
            { text: 'Gazetteer Linking', link: '/guide/link' },
            { text: 'Production Deployment', link: '/guide/production' },
            { text: 'Scenario: PPRL', link: '/guide/scenario-pprl' },
            { text: 'Scenario: LLM-Assisted', link: '/guide/scenario-llm' },
