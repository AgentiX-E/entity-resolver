...
// v17: 1200 LLM reviews + softer deny penalty (0.48) + wider boundary [0.38,0.90]
const boundary=pairs.filter(p=>p.score>=0.38&&p.score<=0.90).slice(0,1200)
...
console.log('\n═══════════════════════════════════')
console.log('  v17: 1200 LLM + softer penalty + 50/50 weights')
console.log('═══════════════════════════════════')
...
console.log('═══════════════════════════════════')
console.log('v16 (800 LLM): 0.522 | v17 (1200 LLM): '+bF1.toFixed(4)+' | GM: 0.628')
}
main()
