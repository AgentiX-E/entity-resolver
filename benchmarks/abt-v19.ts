...
// v17: 2000 LLM reviews + softer deny penalty (0.48) + wider boundary [0.32,0.95]
const boundary=pairs.filter(p=>p.score>=0.35&&p.score<=0.92).slice(0,2000)
...
console.log('\n═══════════════════════════════════')
console.log('  v17: 2000 LLM + softer penalty + 50/50 weights')
console.log('═══════════════════════════════════')
...
console.log('═══════════════════════════════════')
console.log('v16 (800 LLM): 0.522 | v17 (2000 LLM): '+bF1.toFixed(4)+' | GM: 0.628')
}
main()
