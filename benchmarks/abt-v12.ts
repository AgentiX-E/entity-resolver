...
// LLM on boundary [0.40, 0.85]
const boundary=pairs.filter(p=>p.score>=0.40&&p.score<=0.85).slice(0,400)
...
console.log('====================================================================')
console.log('v9 (jw+LLM): 0.443 | GoldenMatch zero-shot (embeddings): 0.628')
}
main()
